...
class GenerateTitles extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate-titles';
    ...
    public function handle(){
        ...
        $response = $client->request('POST', 'https://api.openai.com/v1/chat/completions', [
            ...
            'json' => [
                "model" => "gpt-3.5-turbo",
                "messages" => [["role" => "user", "content" => "Give me 500 unique blog posts titles on '$message'. Put the list in string json array. Remove the number at the beginning of each line"]]
            ]
        ]);
    }
}
